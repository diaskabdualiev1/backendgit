...
class UserRegisterForm(UserCreationForm):
    ...
    email = forms.EmailField(widget=forms.TextInput(attrs={'placeholder': 'Email', 'pattern':'.+@stu\.sdu\.edu\.kz', 'class': 'prompt srch_explore', 'title':'Write your SDU email address'}))
